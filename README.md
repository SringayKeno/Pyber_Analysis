...
Urban city types was the only city type to post more drivers than rides. This might indicate an excess of drivers. Is this just one city with an excess of drivers, several urban cities or is this company wide for urban cities? Is this normal for Pyber in urban areas, or part of a cycle? Further analysis should be done. If a cycle, having to many drivers is not neccessarily a problem. This is according to Gad Allon, Wharton professor of operations, information and decisions. With more drivers, the value for riders go up. For instance the riders might get lower wait times and lower fares. If on the other hand, more riders, the higher the value for drivers such as more work, and less wait times. The combination of the two can result in a powerful cycle, in which the Pyber's costs goes down and the revenue goes up. Again, further Analysis should be done to identify this sample size from Jan-thru end of April 2019. Id this just part of a cycle. 
